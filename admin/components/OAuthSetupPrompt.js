    ...
    <React.Fragment>
      {item.needs_app ?
        <div className="uk-alert-warning" uk-alert="true">
          <p>Before you can {action} your photos, first you have to set up access. Please visit {name} and <a href={item.app_create_url} target="_blank">create an app</a>, then return here and enter the credentials in settings.</p>
      ...
      {!item.needs_app && item.needs_credentials ?
        <div className="uk-alert-primary" uk-alert="true">
          <p>It looks like your permission is required before we can sync this {kind} for you. Clicking this button will send you to {name}&rsquo;s website, where you can grant permission, and you&rsquo;ll be returned here afterwards.</p>
          <div className="uk-panel">
            <p className="uk-align-right">
