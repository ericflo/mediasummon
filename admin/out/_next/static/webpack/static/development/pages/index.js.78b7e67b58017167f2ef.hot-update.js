...
function ServiceSummary(_ref) {
  ...
  var next = sync.end ? dayjs__WEBPACK_IMPORTED_MODULE_3___default()(sync.end).add(service.hours_per_sync, 'hour') : null;
  ...
  return __jsx("div", {
    ...
    __self: this
  }, start), ' ', sync ? '(' + (sync.fetch_count || 0) + ' downloaded) ' : null, __jsx("span", {
...
//# sourceMappingURL=index.js.78b7e67b58017167f2ef.hot-update.js.map