        ...
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            for (i = 0; i < targets.length; ++i) {
              ...
              if (isWindowsStyle === null) {
                isWindowsStyle = target.url.indexOf('://') === -1;
              }

              split = target.url.split(isWindowsStyle ? ':\\\\' : '://');
              target.kind = split[0];
              target.path = split[1];
            }
...
//# sourceMappingURL=index.js.feb1d7116e38f62aaf1d.hot-update.js.map