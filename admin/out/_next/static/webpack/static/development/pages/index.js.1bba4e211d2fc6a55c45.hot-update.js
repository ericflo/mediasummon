...
function ServiceSummary(_ref) {
  ...
  return __jsx("div", {
    ...
    __self: this
  }, document.location + '/auth/' + service.metadata.id + '/return')) : __jsx("p", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 55
    },
    ...
    __self: this
  }, document.location + '/auth/' + service.metadata.id + '/return')), __jsx(_OAuthAppForm__WEBPACK_IMPORTED_MODULE_5__["default"], {
...
//# sourceMappingURL=index.js.1bba4e211d2fc6a55c45.hot-update.js.map